...
const SocialIcon: React.FC<{ platform: string }> = ({ platform }) => {
  return (
    <div className="w-14 h-14 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-all cursor-pointer shadow-xl border border-white/5 active:scale-95">
